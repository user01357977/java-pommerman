...
import static players.rhea_mm.utils.Constants.*;
import static players.rhea_mm.utils.Utilities.index_ind_in_pop;
...
class Selection {
    ...
    Selection(RHEAParams_mm params, Random random) {
        this.params = params;
        this.random = random;
    }
    ...
    public static void main(String[] args) {
        RHEAParams_mm params = new RHEAParams_mm();
