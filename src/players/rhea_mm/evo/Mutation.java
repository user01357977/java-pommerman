...
public class Mutation {
    ...
    private TIntHashSet opp_genesToMutate;

    Mutation(RHEAParams_mm params, Random random) {
        this.params = params;
        this.random = random;
    ...
    public TIntHashSet opp_getGenesToMutate() {
        return opp_genesToMutate;
    }

    public void findGenesToMutate() {
    ...
    void opp_findGenesToMutate() {
        TIntHashSet genesToMutate;

        if (params.mutation_type == MUTATION_BIT) {
            opp_genesToMutate = one_bit_mutation();
        } else if (params.mutation_type == MUTATION_BIAS) {
            opp_genesToMutate = softmax_mutation();
        } else {
            opp_genesToMutate = uniform_mutation();
        }

        this.opp_genesToMutate = opp_genesToMutate;
    }
    ...
    public void mutate(Individual ind, int idx) {
        int max_actions = ind.get_max_actions();
