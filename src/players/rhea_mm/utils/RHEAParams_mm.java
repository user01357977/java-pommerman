...
public class RHEAParams_mm implements ParameterSet {
    ...
    public int individual_length = 7;
    ...
    public int evaluate_update = EVALUATE_UPDATE_RAW;//EVALUATE_UPDATE_AVERAGE;
...
//    public double shift_discount = 0.99;
    ...
    // Budget restrictions
    public int budget_type = TIME_BUDGET;//FM_BUDGET;
    public int iteration_budget = 200;
    public int fm_budget = 2000;
    public int time_budget = 400;
...
//        names.put("draw_code", new String[]{"DRAW_EXPLORATION", "DRAW_THINKING", "DRAW_ALL"});
    ...
    public static void main(String[] args) {
        new RHEAParams_mm().printParameterSearchSpace();
    }
}
