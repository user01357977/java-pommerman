...
import static players.rhea_minimax.utils.Utilities.index_ind_in_pop;
...
class Selection {
    ...
    Selection(RHEAParams_minimax params, Random random) {
        this.params = params;
        this.random = random;
    }
    ...
    public static void main(String[] args) {
        RHEAParams_minimax params = new RHEAParams_minimax();
