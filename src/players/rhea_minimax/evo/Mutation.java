...
import static players.rhea_minimax.utils.Constants.MUTATION_BIAS;
import static players.rhea_minimax.utils.Constants.MUTATION_BIT;
...
public class Mutation {
    ...
    Mutation(RHEAParams_minimax params, Random random) {
        this.params = params;
        this.random = random;
