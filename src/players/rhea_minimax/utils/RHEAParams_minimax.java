package players.rhea_minimax.utils;
...
public class RHEAParams_minimax implements ParameterSet {
    ...
    public boolean elitism = true; //false;
    ...
    public double evaluate_discount = 0.50;
...
//    public double shift_discount = 0.99;
    ...
    private double mc_rollouts_length_perc = 0.2;
    public int mc_rollouts_repeat = 1;

    // Budget restrictions
    public int budget_type = FM_BUDGET;//ITERATION_BUDGET;//FM_BUDGET;
...
//        names.put("draw_code", new String[]{"DRAW_EXPLORATION", "DRAW_THINKING", "DRAW_ALL"});
    ...
    public static void main(String[] args) {
        new RHEAParams_minimax().printParameterSearchSpace();
    }
}
